#### Attention dans le fichier venv/bin/fbs

        #!"/Users/alexandrevermeulen/Desktop/fbs-tutorial-master/venv/bin/python3" 
        
les guillemets doivent être remplacé :

        #!/Users/alexandrevermeulen/Desktop/fbs-tutorial-master/venv/bin/python3 
        
#### Problème d'espace résolu à l'execution de la commande > fbs startproject
...
obtain the path to [`styles.qss`](src/main/python/styles.qss). This is a QSS file, Qt's
...
full code in [`main.py`](src/main/python/main.py).
